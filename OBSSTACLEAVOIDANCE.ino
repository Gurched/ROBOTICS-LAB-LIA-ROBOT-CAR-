/*
This code is made for a robot car to avoid obstacles
when cruising. This puts in application the understanding
of the use of the ultrasonic sensor with decision making.
*/
